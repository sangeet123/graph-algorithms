...
/*
 * This is just a simple test for BFSTraversal algorithm. The test
 * does not assert anything except for weather the BFSTraversal class is 
...
public class BFSTraversalTest {
	...
	public void bfs_traversal_test_for_graph_with_no_edge() throws Exception {
		TraversalAlgorithm traversal = new BFSTraversal(graphWithNoEdge, noEdgeGraphRepresentation);
		traversal.traverse();
	}

	@Test()
	public void bfs_traversal_test_for_graph_with_no_node_and_no_edge() throws Exception {
		TraversalAlgorithm traversal = new BFSTraversal(graphWithNoNodeAndNoEdge, noNodeAndNoEdgeGraphRepresentation);
		traversal.traverse();
	}

	@Test()
	public void bfs_traversal_test_for_undirected_graph() throws Exception {
		TraversalAlgorithm traversal = new BFSTraversal(unidirectedGraph, undirectedGraphRepresentation);
		traversal.traverse();
	}

	@Test()
	public void bfs_traversal_test_for_directed_graph() throws Exception {
		TraversalAlgorithm traversal = new BFSTraversal(directedGraph, directedGraphRepresentation);
		traversal.traverse();
	}

	@Test(expected = IllegalStateException.class)
	public void bfs_traversal_test_for_graph_with_invalid_representation() throws Exception {
		TraversalAlgorithm traversal = new BFSTraversal(directedGraph, undirectedGraphRepresentation);
		traversal.traverse();
